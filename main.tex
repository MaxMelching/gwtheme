...
% \author[\MakeUppercase{Your name (short)}]{Your Name}  % For use with \insertshortauthor in footline
...
{
% \setbeamertemplate{headline}{}  % We do not want GW on here
% \setbeamertemplate{background}{
%     \includegraphics[]{MPItheme/title_bg.pdf}
% }
...
\setbeamertemplate{frametitle}[customMPI]
